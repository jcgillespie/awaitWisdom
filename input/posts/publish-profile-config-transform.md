...
![Publish dialog settings tab](../assets/img/2013/Dec/PublishSettings.PNG)
...
![Default web.config transforms](../assets/img/2013/Dec/DefaultConfigTransforms.PNG)
...
![](../assets/img/2014/Jan/AddConfigTransform.PNG)
**&lt;/Edit&gt;**

Add a new item to your web project using the Project menu.
![Add New Item...](../assets/img/2013/Dec/AddNewItem.PNG)
...
![new config file](../assets/img/2013/Dec/AddNewConfig.PNG)
...
![web.dev.config](../assets/img/2013/Dec/web_dev_config.png)
...
![Web.config transform preview](../assets/img/2013/Dec/TransformPreview.png)
...
![Transformed config](../assets/img/2013/Dec/TransformedConfig.png)
...
![Not Nested](../assets/img/2013/Dec/NotNested.png)
...
![Edited project file](../assets/img/2013/Dec/EditedProject.png)
Reload the application and you'll find it properly nested under the main file.
![Properly Nested](../assets/img/2013/Dec/nested.png)
Much Better!
